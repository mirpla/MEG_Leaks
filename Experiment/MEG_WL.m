function MEG_WL(SubInfo, path, debug, startBlock, pahandle, audio,MEG, selfpaced) 
...
if MEG == 1
    ...
    enctrig = 3; % Indicating Encoding task is being performed coded as multipes of 256 STI101
    frectrig = 4; % Indicating free recall section
    trectrig = 5; % Indicating triggered recall section
    resttrig  = 1; % indicates official rest period coded as as multipes of 512 + x*512on STI101
end
